...
official train/val/test data, you can look in [dataset.py](https://github.com/Marvelous-Artoria-Pendragon/pytorch-video-recognition/blod/master/dataloaders/dataset.py), and modify it to your needs.
