...
official train/val/test data, you can look in [dataset.py](https://github.com/Marvelous-Artoria-Pendragon/video-recognition/blob/master/dataloaders/dataset.py), and modify it to your needs.
